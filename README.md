...
A light-DOM web component for high-touch border effects — twenty-two of them,
...
| ----------- | ---------------------------------------------------------------------------------------------------- |
| `effect`    | One of: `aurora`, `barber`, `chroma`, `wings`, `lightning`, `neon`, `glitch`, `ascii`, `stitching`, `typewriter`, `barbed-wire`, `rope`, `scallop`, `scoop`, `zigzag`, `wave`, `psychedelic`, `plasma`, `sparks`, `marquee`, `squiggle`, `draw`. |
...
The binder applies the **extreme** effects (all twenty-two) directly to the
